...
public class TestAutoK extends CommandOpMode{
    ...
    double SPEED_GAIN  =  0.12; // TODO ==== CHANGE THESE VALUES ====  Forward Speed Control "Gain". eg: Ramp up to 50% power at a 25 inch error.   (0.50 / 25.0)
...
//            try {
            ...
            List<AprilTagDetection> currentDetections = aprilTag.getDetections();
            telemetry.addData("getDetection",currentDetections);
            telemetry.update();
