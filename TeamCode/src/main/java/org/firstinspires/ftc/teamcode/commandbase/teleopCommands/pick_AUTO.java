...
public class pick_AUTO extends SequentialCommandGroup {
    public pick_AUTO(intakeSubsystem intake, outakeSubsystem outake) {
        super(
                new ParallelCommandGroup(new rackCommand(intake, intakeSubsystem.RackState.AUTO_TOP_PIXEL),
