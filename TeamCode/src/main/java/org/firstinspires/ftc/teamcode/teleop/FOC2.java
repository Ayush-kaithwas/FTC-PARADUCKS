...
import static org.firstinspires.ftc.teamcode.commandbase.subsytem.HangerAndDrone.pos;
...
@Config
@TeleOp(name = "FOC2")
public class FOC2 extends CommandOpMode {
...
//    List<LynxModule> allHubs = null;
    ...
    public void initialize() {
        ...
        Pose2d startPose = new Pose2d(0, 0, Math.toRadians(angleFC));
...
//        schedule(new intake_init(intake,outake));
    ...
    public void run() {
        ...
        Vector2d input = new Vector2d(Math.pow(Range.clip(gamepad1.left_stick_x, -1, 1), 3), Math.pow(Range.clip(-gamepad1.left_stick_y, -1, 1), 3)).rotated(-poseEstimate.getHeading());
...
//
        ...
        telemetry.addData("IMU",poseEstimate.getHeading());
        telemetry.update();
