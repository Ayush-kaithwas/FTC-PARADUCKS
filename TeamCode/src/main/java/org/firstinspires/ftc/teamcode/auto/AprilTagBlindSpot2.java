...
@Config
@Autonomous(group = "AprilAuto2")
//@Autonomous(group = "drive")
public class AprilTagBlindSpot2 extends CommandOpMode{
    ...
    public double Ycurrent = 43.5; //23.5, 43.4
    public double Hcurrent = Math.toRadians(0);
...
//        //TODO: THESE TRAJECTORIES WILL TAKE YOUR BOT TO THE APRIL TAG DETECTION POSITION UPDATE IT ACCORDING TO YOUR BOT
    ...
    public void AprilTagAuto(int Aprilobject){
            desiredTag = null;
            DESIRED_TAG_ID = Aprilobject;
