...
public class AprilTagAuto extends CommandOpMode{
    ...
    public double MAX_AUTO_SPEED = 1;   //  Clip the approach speed to this max value (adjust for your robot)
    public double MAX_AUTO_STRAFE= 1;   //  Clip the approach speed to this max value (adjust for your robot)
    public double MAX_AUTO_TURN  = 0.5;   //  Clip the turn speed to this max value (adjust for your robot)
...
//        //TODO: THESE TRAJECTORIES WILL TAKE YOUR BOT TO THE APRIL TAG DETECTION POSITION UPDATE IT ACCORDING TO YOUR BOT
        ...
        try {
            ...
            TrajectorySequence BackdropPose = drive.trajectorySequenceBuilder((newPose))
                    .lineToConstantHeading(new Vector2d(38, 44)) // TODO CHANGE THIS ACCORDING TO THE ROBOT CURRENT POSE
                    .build();
