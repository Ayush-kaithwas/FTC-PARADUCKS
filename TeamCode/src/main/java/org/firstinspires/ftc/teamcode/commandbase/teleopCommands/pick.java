...
public class pick extends SequentialCommandGroup {
    public pick(intakeSubsystem intake, outakeSubsystem outake) {
        super(
...
//                        new outGripperCommand(outake, outakeSubsystem.OutGripperState.CLOSE),
                ...
                new WaitCommand(500),//new//1000
                new outGripperCommand(outake, outakeSubsystem.OutGripperState.CLOSE),//new
